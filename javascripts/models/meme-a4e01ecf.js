MEME.MemeModel = Backbone.Model.extend({
    ...
    loadBackground: function(t) {
        this.loadFileForImage(t, this.background)
    },
    loadWatermark: function(t) {
        this.loadFileForImage(t, this.watermark)
    },
    setWatermarkSrc: function(t) {
        var e = _.findWhere(this.get("watermarkOpts"), {
                value: t
            }),
            a = e && e.data || t;
        0 === a.indexOf("data:") ? this.watermark.removeAttribute("crossorigin") : this.watermark.setAttribute("crossorigin", "anonymous"), this.watermark.src = a, this.set("watermarkSrc", t)
    }
});